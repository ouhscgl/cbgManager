...
def main(input_fileName, output_fileName, input_type):
    if input_type == 1:
        print("__________________________________________________\n"
              ...
              " Kaposzta, MD and\n collaborators. Intended for use within Oklahoma\n"
...
if __name__ == "__main__":
    ...
    parser.add_argument("input_type",  help="Type of input. 1 for direct, 0 for relayed.", type=int, choices=[0,1])
    args = parser.parse_args()
    
    main(args.input_file, args.output_file, args.input_type)
    
    # runfile('requestUserInput', args = '/Users/medicabg/Desktop/Untitled.txt /Users/medicabg/Desktop/Untitled2.txt 1')
